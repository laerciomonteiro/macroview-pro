...
import { determineScenario } from '~/utils/scenario'
import type { 
  MarketOverview, 
  CurrencyData, 
  CommodityData, 
...
export const useMarketStore = defineStore('market', {
  ...
  getters: {
    ...
    scenario(): ScenarioResult | null {
      ...
      const vixChangePercent = this.marketData.riskIndicators.vixChangePercent || 0
      
      // Use centralized determineScenario function
      const analysis = determineScenario({ vix, dxy, vixChangePercent })
